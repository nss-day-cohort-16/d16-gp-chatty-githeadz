...
var Cathy = (function (oldCathy) {
  ...
  oldCathy.writeMsgDOM = function(elementID, msgObject, idCounter){
    var msgHTML = '';
    msgHTML += '<li class="right clearfix" id="' + idCounter + '" style="color:' + txtPicker.value + '; background:' + bgPicker.value + '"><span class="chat-img pull-right"><img src="http://placehold.it/50/008844/fff&text=';
    msgHTML += msgObject.user.slice(0, 3);
    msgHTML += '" alt="User Avatar" class="img-circle"><button class="btn btn-default" type="button" style="color:' + txtPicker.value + '; background:' + bgPicker.value + '">Delete</button></span><div class="chat-body clearfix"><div class="header"><small><span class="glyphicon glyphicon-time"></span>';
